  ...
  return (
    <span className={className} style={{ display: 'inline-flex', alignItems: 'center', gap: '0.625rem', pointerEvents: 'none' }}>
      ...
      >
        ...
        {/* Document Icon */}
        <path 
          d="M32 28C32 26.3431 33.3431 25 35 25H58L72 39V72C72 73.6569 70.6569 75 69 75H35C33.3431 75 32 73.6569 32 72V28Z" 
          fill="white" 
        />
        ...
        {/* Lines on paper */}
        <rect x="40" y="46" width="22" height="3" rx="1.5" fill="#0f3d5c" fillOpacity="0.2" />
        <rect x="40" y="54" width="22" height="3" rx="1.5" fill="#0f3d5c" fillOpacity="0.2" />
        <rect x="40" y="62" width="14" height="3" rx="1.5" fill="#0f3d5c" fillOpacity="0.2" />
        
        {/* Forge/Spark element - stylized circle at bottom right */}
        <circle cx="70" cy="70" r="14" fill="#ef4444" />
        
        {/* Inner spark/star */}
        <path 
          d="M70 62L72 68H78L73 72L75 78L70 74L65 78L67 72L62 68H68L70 62Z" 
          fill="white" 
        />
      </svg>
